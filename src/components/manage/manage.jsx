...
class Manage extends Component {
  ...
  connectionConnected = () => {
    ...
    setTimeout(() => {
      const snackbarObj = {
        snackbarMessage: "Wallet succesfully connected.",
        snackbarType: "Info",
      };
  ...
  metamaskConnected = () => {
    ...
    setTimeout(() => {
      const snackbarObj = {
        snackbarMessage: "Metamask wallet succesfully connected.",
        snackbarType: "Info",
      };
      that.setState(snackbarObj);
    });
  ...
  ledgerConnected = () => {
    ...
    setTimeout(() => {
      const snackbarObj = {
        snackbarMessage: "Ledger succesfully connected.",
        snackbarType: "Info",
      };
      that.setState(snackbarObj);
    });
      ...
      <div className={classes.root}>
        <div className={classes.investedContainer}>
          {account.address && (
            <div className={classes.intro}>
              <Typography variant="h3">
                Management. You should probably not be here.
              </Typography>
            </div>
          )}
          {!account.address && (
          ...
          <div className={classes.balancesContainer}>
            {false && (
              <div className={classes.overlay} onClick={this.overlayClicked}>
  ...
  renderAssetBlocks = () => {
    ...
    return assets.map((asset) => {
      return (
        <Accordion
          square
          key={asset.symbol + "_expand"}
          expanded={expanded === asset.symbol}
          onChange={() => {
            this.handleChange(asset.symbol);
          }}
        ...
        >
          ...
          >
            <div className={classes.assetSummary}>
              ...
              <div className={classes.heading}>
                <Typography className={classes.heading} variant={"h3"}>
                  {formatter.format(asset.poolValue) +
                    " " +
