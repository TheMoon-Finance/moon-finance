      ...
      <tr className={classes.pair}>
        <th className={classes.headerName}>
          <Typography
            align="right"
            variant={"h4"}
            className={classes.aggregatedHeader}
          >
            {"Vault"}
          </Typography>
        </th>
        ...
        <th className={classes.headerValue}>
          <Typography
            align="right"
            variant={"h4"}
            className={classes.aggregatedHeaderRight}
          >
            {"Vault holdings"}
          </Typography>
        </th>
        ...
        <th className={classes.headerROI}>
          <Typography
            align="right"
            variant={"h4"}
            className={classes.aggregatedHeaderCenter}
          >
            {"ROI based on sampled period"}
          </Typography>
          <div className={classes.subHeader}>
            <div className={classes.headerValue}>
              <Typography
        ...
        return (
          <tr key={asset.id} className={classes.pair}>
            <td
              ...
              onClick={() => {
                window.open(
                  `https://etherscan.io/address/${asset.vaultContractAddress}#code`,
                  "_blank"
                );
              }}
            >
            ...
            <td
              ...
              onClick={() => {
                window.open(
                  `https://etherscan.io/address/${asset.strategy}#code`,
                  "_blank"
                );
              }}
            >
            ...
            <td className={classes.apr2}>
              <Typography align="right" variant="h5" className={classes.inline}>
                {asset.vaultHoldings
                  ? parseFloat(asset.vaultHoldings.toFixed(2)).toLocaleString()
                  : "0.00"}{" "}
                <div className={classes.symbol}>{asset.symbol}</div>
              </Typography>
            </td>
            <td className={classes.apr2}>
              <Typography align="right" variant="h5" className={classes.inline}>
                {asset.strategyHoldings
                  ? parseFloat(
                      asset.strategyHoldings.toFixed(2)
                    ).toLocaleString()
                  : "0.00"}{" "}
                <div className={classes.symbol}>{asset.symbol}</div>
              </Typography>
            ...
            <td className={classes.apr1}>
              <Typography align="right" variant="h5" className={classes.inline}>
                {asset.vaultBalance
                  ? parseFloat(
                      (asset.vaultBalance * asset.pricePerFullShare).toFixed(2)
                    ).toLocaleString()
                  : "0.00"}{" "}
                <div className={classes.symbol}>{asset.symbol}</div>
              </Typography>
            ...
            <td className={classes.apr1}>
              <Typography align="right" variant="h5" className={classes.inline}>
                <div className={classes.preSymbol}>$</div>
                {asset.vaultBalance
                  ? parseFloat(
                      (
                        asset.vaultBalance *
            ...
            <td className={classes.apr1}>
              <Typography align="right" variant="h5" className={classes.inline}>
                {asset.stats && asset.stats.apyOneWeekSample
                  ? parseFloat(
                      asset.stats.apyOneWeekSample.toFixed(2)
                    ).toLocaleString()
                  : "0.00"}
            ...
            <td className={classes.apr1}>
              <Typography align="right" variant="h5" className={classes.inline}>
                {asset.stats && asset.stats.apyOneMonthSample
                  ? parseFloat(
                      asset.stats.apyOneMonthSample.toFixed(2)
                    ).toLocaleString()
                  : "0.00"}
                <div className={classes.symbol}>%</div>
              </Typography>
            ...
            <td className={classes.apr1}>
              <Typography align="right" variant="h5" className={classes.inline}>
                {asset.stats && asset.stats.apyInceptionSample
                  ? parseFloat(
                      asset.stats.apyInceptionSample.toFixed(2)
                    ).toLocaleString()
                  : "0.00"}
                <div className={classes.symbol}>%</div>
              </Typography>
