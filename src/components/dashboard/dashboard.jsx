...
const styles = (theme) => ({
  ...
  portfolioBalanceContainer: {
    boxShadow: "0px 0px 20px 11px #47d390;",
  },
  growthBalance: {
    color: "#ff5c93",
  },
  portfolioGrowthContainer: {
    boxShadow: "0px 0px 20px 11px #ff5c93;",
  },
  between: {
    width: "90px",
    height: "40px",
  ...
  titleBalance: {
    ...
    flex: 1,
    cursor: "pointer",
    //boxShadow: "0px 0px 20px 11px #220445;",
  },
  prettyAlign: {
    display: "flex",
    alignItems: "center",
...
class Dashboard extends Component {
  ...
  render() {
    ...
    const { loading, dashboard, growth, currency, account } = this.state;
      ...
      <div className={classes.root}>
        <div className={classes.investedContainer}>
          <div className={classes.portfolioContainer}>
            <div
              className={`${classes.titleBalance} ${classes.portfolioBalanceContainer}`}
              onClick={this.balanceClicked}
            >
              <Typography variant={"h4"} className={classes.title}>
                Portfolio Balance
              </Typography>
              {currency === "USD" && (
                <Typography variant={"h2"} className={classes.portfolioBalance}>
                  ${" "}
                  {parseFloat(
              ...
              {currency === "ETH" && (
                <div className={classes.inline}>
                  <Typography
                    variant={"h2"}
                    noWrap
                    className={classes.portfolioBalance}
                  >
                    {parseFloat(
            ...
            {growth === 0 && (
              <div
                className={`${classes.titleBalance} ${classes.portfolioGrowthContainer}`}
                onClick={this.growthClicked}
              >
                <Typography
                  variant={"h4"}
                  className={`${classes.title} ${classes.prettyAlign}`}
                >
                  Daily Growth
                </Typography>
                {currency === "USD" && (
                  <Typography variant={"h2"} className={classes.growthBalance}>
                    ${" "}
                    {parseFloat(
                ...
                {currency === "ETH" && (
                  <div className={classes.inline}>
                    <Typography
                      variant={"h2"}
                      noWrap
                      className={classes.growthBalance}
                    >
                      {parseFloat(
            ...
            options.map((option) => {
              return (
                <MenuItem key={option.value} value={option.value}>
                  <Typography variant="h4" className={classes.assetSelectRoot}>
                    {option.description}
                  </Typography>
                </MenuItem>
              );
